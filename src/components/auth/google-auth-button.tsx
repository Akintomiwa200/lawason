  ...
  if (status === "loading") {
    return (
      <button
        ...
        disabled
        className={cn(
          "inline-flex items-center justify-center rounded-full border border-border bg-surface px-5 py-2.5 text-sm font-medium text-muted",
          className,
        )}
      >
        Loading…
    ...
    <button
      ...
      className={cn(
        compact
          ...
          : "inline-flex items-center justify-center gap-2 rounded-full bg-accent px-5 py-2.5 text-sm font-semibold text-accent-foreground shadow-glow transition hover:brightness-110",
        className,
      )}
    >
      {compact ? "Sign in" : (
