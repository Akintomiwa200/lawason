...
import { clientLogos } from "@/components/selected-work/data";
  ...
  return (
    <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14 xl:gap-16">
      <AnimatedReveal y={60}>
        ...
        <h1 className="mt-6 max-w-[14ch] text-[42px] font-medium leading-[0.95] tracking-[-0.04em] text-[#1a1a1a] dark:text-foreground md:text-[56px] lg:text-[72px]">
          Work that moves from set to{" "}
        ...
        <p className="mt-6 max-w-md text-base leading-[1.7] text-[#6b6560] dark:text-muted md:text-[17px]">
          From The Gaffer Man Show to specialist lighting teams on Nollywood
          productions — explore {company.name}&apos;s projects, collaborations,
