    ...
    <footer className="mt-auto border-t border-border/60 bg-surface">
      <div className="mx-auto w-full max-w-6xl px-6 py-14">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4 lg:gap-8">
          ...
          <FooterColumn heading="Studio" links={footerNav.studio} />
...
function SocialLink({
  ...
  return (
    <a
      ...
      rel="noreferrer"
      aria-label={label}
      className="inline-flex h-9 w-9 items-center justify-center rounded-full text-accent transition hover:bg-accent/10 hover:brightness-110"
    >
      {children}
    </a>
  );
